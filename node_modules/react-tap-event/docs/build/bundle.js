...
/******/ 	var hotCurrentHash = "1f2f7246df8cc9968969"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! E:\project\github\react-tap\docs\index.js */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../index.js */ 4);
	
	__webpack_require__(/*! ./demo.less */ 8);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'tap button', onTap: function onTap() {
	                                return _this2.onTap(1);
	                            }, tapActive: true },
	                        'tap1'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'tap button', onTap: function onTap() {
	                                return _this2.onTap(2);
	                            }, tapActive: 'tap-ripple' },
	                        'tap2'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'tap button', onTap: function onTap() {
	                                return _this2.onTap(3);
	                            }, tapActive: 'green' },
	                        'tap3'
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createTapEvent = __webpack_require__(/*! ./createTapEvent.js */ 5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./index.less */ 6);
	...
	// 缓存坐标位置等属性
	var storeTouchKeys = function storeTouchKeys(touch, target) {
	...
	var fakeTapEvent = function fakeTapEvent(event) {
	 ...
	 * 增加点击态功能
	 */
	var wrapTap = function wrapTap(onTap, tapActive) {
	...
	var onTouchMove = function onTouchMove(callback, event) {
	    ...
	    // 判断手指移动距离是否过大
	    if (Math.abs(touchEvents.startPos.clientX - touchEvents.lastPos.clientX) > MOVE_THRESHOLD || Math.abs(touchEvents.startPos.clientY - touchEvents.lastPos.clientY) > MOVE_THRESHOLD) {
	...
	var onTouchEnd = function onTouchEnd(callback, onTap, type, tapActive, event) {
	    touchEvents.touched = true;
	    touchEvents.lastTouchDate = new Date().getTime();
	        ...
	        if (touchEvents.lastPos.clientX - (touchEvents.lastPos.radiusX || 0) <= box.right && touchEvents.lastPos.clientX + (touchEvents.lastPos.radiusX || 0) >= box.left && touchEvents.lastPos.clientY - (touchEvents.lastPos.radiusY || 0) <= box.bottom && touchEvents.lastPos.clientY + (touchEvents.lastPos.radiusY || 0) >= box.top) {
	            ...
	            if (!isDisabled(event.currentTarget)) {
	                if (typeof onTap === 'function') {
	                    ...
	                    // 修复iOS滚动点停问题
	                    if (isIOS && !touchEvents.hasStart) {} else {
	...
	var createTapEvent = function createTapEvent(type, props) {
	    var newProps = {};
